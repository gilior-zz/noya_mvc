    ...
    var juicebox = function(cnfg) {
        ...
        var get_gallery_frame_html = function() {
            ...
            if (!context.utils.ship) {
                badge = "<div class='stupidLogo' " + get_badge_style_str() + ($.browser.msie ? "" : " !important") + ";background: " + get_badge_image_url() + " no-repeat 0 0 !important;cursor:pointer;margin:0 !important;padding:0 !important;bottom:0 !important;right:0 !important' " + get_badge_link() + "></div>"
            }
            if (context.utils.is_adobe_air()) {
                badge = badge.replace("<div class='stupidLogo' style=", "<div class='" + ["j", "b", "-", "b", "a", "d", "g", "e"].join("") + "' style=").replace(";background: " + get_badge_image_url() + " no-repeat 0 0 !important;", ";")
            }
