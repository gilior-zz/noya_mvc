...
*/
	...
	function loadYoumax() {		
		...
		$('#youmax').append('<div id="youmax-encloser"><div id="iframeWrapper" class="embed-responsive embed-responsive-16by9"><iframe class="embed-responsive-item" id="youmax-video"  src=""  allowfullscreen></iframe></div><div class="row" id="youmax-video-list-div"></div></div>');
		...
		//function getUploads() {
		//    showLoader();
		//    var apiUploadURL = "https://gdata.youtube.com/feeds/api/videos/ajrP2l2NVl8?v=2";
		//    $.ajax({
		//        url: apiUploadURL,
		//        type: "GET",
		//        async: true,
		...
		function showPlaylistVideos(response) {
			...
			$('.youmax-video-tnail-box').click(function(){
				...
				if(showVideoInLightbox){
				    ...
				    $('#youmax-video').attr('src', 'http://www.youtube.com/embed/' + this.i + '?autoplay=1');
					$('#youmax-video').show();
					$('#iframeWrapper').show();
