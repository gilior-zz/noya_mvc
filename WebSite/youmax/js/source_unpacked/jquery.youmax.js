...
var getYouTubePlaylistVideos = function (playlistId, tabId, pageToken, $youmaxContainer) {
    ...
    apiPlaylistVideosURL = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=" + playlistId + "&maxResults=" + youmax_global_options.maxResults + pageTokenUrl + "&key=" + youmax_global_options.apiKey;
...
getVimeoUserVideos = function (userId, tabId, pageToken, $youmaxContainer) {
    ...
    apiVimeoVideosURL = "https://api.vimeo.com/users/" + userId + "/videos?access_token=" + youmax_global_options.vimeoAccessToken + "&per_page=" + youmax_global_options.maxResults + pageTokenUrl;
...
getVimeoChannelVideos = function (channelId, tabId, pageToken, $youmaxContainer) {
    ...
    apiVimeoVideosURL = "https://api.vimeo.com/channels/" + channelId + "/videos?access_token=" + youmax_global_options.vimeoAccessToken + "&per_page=" + youmax_global_options.maxResults + pageTokenUrl;
...
getVimeoGroupVideos = function (groupId, tabId, pageToken, $youmaxContainer) {
    ...
    apiVimeoVideosURL = "https://api.vimeo.com/groups/" + groupId + "/videos?access_token=" + youmax_global_options.vimeoAccessToken + "&per_page=" + youmax_global_options.maxResults + pageTokenUrl;
...
getVimeoAlbumVideos = function (albumId, tabId, pageToken, $youmaxContainer) {
    ...
    apiVimeoVideosURL = "https://api.vimeo.com/albums/" + albumId + "/videos?access_token=" + youmax_global_options.vimeoAccessToken + "&per_page=" + youmax_global_options.maxResults + pageTokenUrl;
...
getYouTubeChannelEvents = function (channelId, tabId, pageToken, $youmaxContainer) {
    ...
    if (createFlag) {
        ...
        setTimeout(function () {
            ...
            //completed events
            apiEventVideosURL = "https://www.googleapis.com/youtube/v3/search?part=snippet" + "&eventType=completed&order=date" + "&channelId=" + channelId + "&type=video&maxResults=" + youmax_global_options.maxResults + "&key=" + youmax_global_options.apiKey;
        ...
        apiEventVideosURL = "https://www.googleapis.com/youtube/v3/search?part=snippet" + "&eventType=completed&order=date" + "&channelId=" + channelId + "&type=video&maxResults=" + youmax_global_options.maxResults + pageTokenUrl + "&key=" + youmax_global_options.apiKey;
...
getYouTubeChannelPlaylists = function (channelId, tabId, pageToken, $youmaxContainer) {
    ...
    //var channelId = playlistTabId.substring(playlistTabId.indexOf("_")+1);
    apiChannelPlaylistsURL = "https://www.googleapis.com/youtube/v3/playlists?part=contentDetails,snippet&channelId=" + channelId + "&maxResults=" + youmax_global_options.maxResults + pageTokenUrl + "&key=" + youmax_global_options.apiKey;
...
createGrid = function ($youmaxContainer, itemType, createFlag, loadMoreFlag, paginateFlag, $items) {
    ...
    $("#youmax").imagesLoaded().always(function () {
...
getUserSearchVideos = function (searchQuery, tabId, pageToken, $youmaxContainer) {
    ...
    if (youmax_global_options.searchBoxScope != "playlist") {
        ...
        apiSearchURL = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + searchQuery + "&order=relevance" + restrictedChannelsString + "&type=video&maxResults=" + youmax_global_options.maxResults + pageTokenUrl + "&key=" + youmax_global_options.apiKey;
...
youmax = function fff(options) {

    var youmax_global_options = {};
    var $youmaxContainer = $("#youmax");
    //console.log($youmaxContainer.attr('id'));
